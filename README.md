...
<img width="1080" height="607" alt="Belajar PHP Dasar" src="https://github.com/user-attachments/assets/0dfd3a48-7589-4ae9-bdf6-bec9d3101fcb" />

### Variable_PHP
Gambar ini sebuah file PHP yang berfokus pada penggunaan variabel untuk menampilkan data. Judul Halaman: "Belajar PHP Dasar", Fokus Utama: Bagian "Data Mahasiswa", Isi Data NIM: 0411500400 & Nama: Abdullah
<img width="1080" height="607" alt="Variable PHP" src="https://github.com/user-attachments/assets/31497954-89c0-4ed5-b0cb-cb9c58e3f059" />

### Predefine_Variable_$_GET
Gambar ini menunjukkan Anda sedang mempraktikkan penggunaan Variabel Predefine dalam PHP, khususnya $_GET. Judul: "Predefine Variable", Hasil: "Selamat Datang Lionel Messi."
<img width="1080" height="607" alt="Predefine Variable $_GET" src="https://github.com/user-attachments/assets/c7faae97-d0b4-4a31-ac75-c41bbf541017" />
...
### hasil Operator dari form_input
Gambar 2 (Form Input Hasil): Menampilkan formulir yang sama, tetapi di bawahnya terdapat hasil pemrosesan data `(Nama, Tanggal Lahir, Umur, Status Umur, Pekerjaan)` berhasil diambil dan dicetak.
Terdapat pemrosesan logis yang dilakukan oleh PHP:Data Pekerjaan dipecah menjadi Pekerjaan `(Software Engineer)` dan Gaji `(Rp 6.000.000)` & Dihitung nilai Take Home Pay `(Rp 5.400.000)`, yang mengindikasikan adanya perhitungan pengurangan `(mungkin 10% pajak atau potongan lainnya)` yang diprogram di PHP.
<img width="681" height="847" alt="Form Input Hasil" src="https://github.com/user-attachments/assets/095e0dff-3496-4604-871a-a477d77afc86" />

### Kondisi_IF
menunjukkan praktik dasar penggunaan Struktur Kontrol Kondisi if dalam PHP. 
1. Input: Pengguna memasukkan data "Rabu" ke dalam form.
2. Proses: Setelah tombol "Cek IF" diklik, kode PHP melakukan percabangan/pengecekan terhadap nilai input tersebut
3. Output: "Hasilnya Hari biasa ☀️"
<img width="417" height="323" alt="Kondisi If" src="https://github.com/user-attachments/assets/778ebb37-a6df-4fdc-ad20-7c7f8075290c" />

### Kondisi_Switch 
menunjukkan praktik penggunaan Struktur Kontrol Kondisi switch dalam PHP. 
1. Input: Pengguna memasukkan kata bahasa Inggris "Wednesday" 
2. Proses: Setelah tombol "Cek Switch" diklik, kode PHP menggunakan pernyataan switch untuk memeriksa nilai input `("Wednesday")` terhadap beberapa kasus `(case)`
3. Output: "Hasil: Rabu"
<img width="386" height="256" alt="Kondisi Switch" src="https://github.com/user-attachments/assets/78541e8b-b28b-449b-9435-3f0d6ab67dfa" />

### Perulangan_For 
menunjukkan praktik penggunaan struktur perulangan for dalam PHP. 
1. Input: Pengguna memasukkan angka batas yaitu 10.
2. Proses: Setelah tombol "Jalankan" diklik, kode PHP menggunakan loop for yang akan dimulai dari 1 hingga mencapai angka 10.
3. Output: "Ke-1" hingga "Ke-10" dicetak secara berurutan.
<img width="382" height="275" alt="Perulangan For" src="https://github.com/user-attachments/assets/d654dd56-b586-4c1a-8c8d-b24ff6e247fd" />

### Perulangan_While 
menunjukkan praktik penggunaan struktur perulangan while dalam PHP.
1. Input Batas: Pengguna memasukkan angka 15.
2. Proses: Setelah tombol "Jalankan" diklik, kode PHP menggunakan loop while untuk melakukan perulangan selama sebuah kondisi bernilai benar `(yaitu, selama counter belum mencapai angka 15)`.
3. Output: Angka 1 hingga 15 dicetak secara berurutan.
<img width="377" height="267" alt="Perulangan While" src="https://github.com/user-attachments/assets/0f1f4d37-590d-4bd1-a32a-a3be9d2db01d" />

### Perulangan_Dowhile
menunjukkan praktik penggunaan struktur perulangan do...while dalam PHP.
1. Input Batas: Pengguna memasukkan angka 25.
2. Proses: Setelah tombol "Jalankan" diklik, kode PHP menggunakan loop do...while. Ciri khasnya adalah blok kode akan dieksekusi minimal satu kali `(do)` sebelum kondisi perulangan diperiksa `(while)`.
3. Output: Angka 1 hingga 25 dicetak.
<img width="387" height="305" alt="Perulangan Dowhile" src="https://github.com/user-attachments/assets/e36ce426-1f0d-4574-852a-a9e522e5b1bd" />

### codingan keseluruhan yaitu Dasar_PHP, Variable_PHP, Predefine_Variable_$_GET, Membuat_Form_Input, hasil Operator dari form_input, Kondisi_IF, Kondisi_Switch, Perulangan_For, Perulangan_While, Perulangan _ Dowhile
